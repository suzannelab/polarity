...
DISTNAME = 'polarity'
DESCRIPTION = 'polarity modeling based on tyssue'
MAINTAINER = 'Guillaume Gay'
MAINTAINER_EMAIL = 'guillaume@damcb.com'
URL = 'https://github.com/glyg/leg-disk'
LICENSE = 'MPL-2.0'
DOWNLOAD_URL = 'https://github.com/damcb/polarity.git'
...
def get_version_info():
    ...
    elif os.path.exists('polarity/version.py'):
...
def write_version_py(filename='polarity/version.py'):
    cnt = """
